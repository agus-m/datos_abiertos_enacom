...
url = 'http://api.datosabiertos.enacom.gob.ar/api/v2/resources.json/?auth_key=' + auth_key
...
for i in range(len(guid_list)):
    url_bucle = 'http://api.datosabiertos.enacom.gob.ar/api/v2/datastreams/'+ guid_list[i] + '/data.json/?auth_key=' + auth_key
    print()
    print(url_bucle)
    headers = {"User-Agent": "Mozilla/5.0"}
